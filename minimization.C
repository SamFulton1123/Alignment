...
int minimization(const char * minName = "Minuit2",const char *algoName = "" , int randomSeed = -9999)
{
   ...
   double variable[18] = {0, 0.00525824, -0.00150999, 0.00366674, -0.00528591, 0.00282695, -0.00800635, 0.00459954, -0.0202021, 0.0103357, -0.0198123, 0.00679557, -0.0309972, -0.00642118, -0.0282164, -0.0050308, -2.22761, -4.15851};
